    ...
    <View style={styles.container}>
      ...
      <ScrollView style={{ width: "100%" }}>
        ...
        <GooglePlacesAutocomplete
          ...
          query={{
            key: "AIzaSyAnQYEHDV7yLhUtqX_rKPCL3NjldMJ94ro",
            language: "pt-br",
        ...
        <TouchableOpacity style={styles.buttonSalvar} onPress={()=>sendData(nome, apelido, endereco, especie, pix, descriptionPartida, telefone)||navigation.navigate("Home")}>
